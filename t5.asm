...
ciclodelectura:
        ...
        mov num,AX                   ;  muevo el valor a la variable num
es_par:
        mov di,1                  ; iniciar la variable en 1   
        mov si,0                ; iniciar la variable en 1               
...
valida:
        ...
        cmp al,0h                    ; comparo con cero
        je es_cero                   ; pantalla cuando es cero 
        cmp al,1h                    ; comparo con uno
...
primo:
        call init                    ; limpio datos
        mov ax, di                   ; muevo el contador a AX
...
print:
        ...
        mov bx, si               ; muevo el valor a ax
        cmp bl,2h                    ; comparo el valor con 2
        jge noprimo                  ; si no es igual 
        mov ah,09                    ; Para mostrar en pantalla una cadena
